...
public TableHeaderRenderer(TableCellRenderer baseRenderer) { 
    ...
    @Override 
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocuscolumn) { 
        JComponent c = (Component)baseRenderer.getTableCellRendererComponent(table,value,isSelected,hasFocus,rowc.setBorder(new EmptyBorder(2,2,2,2))); 
        return c; 
    } 
} 
//End Design Elements. 
class login implements ActionListener { 
    ...
    TextField userField, stu_t, stuname_t, stubrn_t; 
    ...
    login() { 
        ...
        stuname_t.setHorizontalAlignment(TextField.CENTER); 
        ...
        stubrn_t.setHorizontalAlignment(TextField.CENTER); 
        ...
        new_book.add(bid_l); 
        bid_T.setForeground(Color.WHITE); 
        ...
        pub_t.setHorizontalAlignment(TextField.CENTER); 
        ...
        sturet_t = new JLabel("Student ID");
...
public void actionPerformed(ActionEvent e) { 
    ...
    if (e.getSource() == save_book) { 
        ...
        try { 
            ...
            conn = DriverManager.getConnection(url, userName, password); stmt = conn.createStatement(); 
            // Execute statements 
            String sql = "insert into book values(" + bid_tString +",'" + bname_tString + pub_tString + in + 1 + pubdate_tString +"','" + no_of_copy_tString + ");"; 
            stmt.executeUpdate(sql); 
            System.out.println("Inserted Succesfully"); 
            bid_t.setText(""); 
            bname_t.setText("");
        ...
        try { 
            ...
            while (rs.next()) { 
                ...
                if (flag == 1) { 
                    ...
                    String sql = "update book set availability=" + (temp_avail + 1) + " where Book_ID=" + temp_bookid + temp_stmt.executeUpdate(sql); 
                } else {
